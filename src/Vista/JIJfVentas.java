...
public class JIJfVentas extends javax.swing.JInternalFrame {
    ...
    private static String formatDecimal(double number) {
        // Utilizamos el formato "#,##0.00" para asegurarnos de que siempre haya al menos un dígito antes del punto decimal
    ...
    void pdf() {
        try {
            ...
            String dir = "Lote N° 97 de la Parcelación del Fundo La Estrella, Lima";
            ...
            info.setAlignment(Element.ALIGN_JUSTIFIED);
            info.setAlignment(Element.ALIGN_RIGHT);
            info.add("Pagó: S/ " + txtPresupuesto.getText() + "\n\n");
            info.setAlignment(Element.ALIGN_JUSTIFIED);
            info.setAlignment(Element.ALIGN_RIGHT);
